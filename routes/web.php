...
Route::get('/contact', [WelcomeController::class, 'contact']) ->name('contact')->middleware('dashboard');
...
Route::get('/password-generator', [WelcomeController::class, 'passwordGenerator']) ->name('password-generator');
